...
## Project Structure
    ...
    ├── testapiautosetting_124863  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_124863`
...
2. Clone this repo and `cd testapiautosetting_124863`
